    ...
    <section ref={rootRef} className={clsx(styles.root, 'layout-grid-inner')}>
      ...
      {isMobile ? (
        <div className={styles.textMobile}>
          <AppearTitle>
            <h4 className={clsx('h4', 'bold')}>Tech Integrators</h4>
          </AppearTitle>
          <AppearTitle>
            <div className="p-l">Building systems and digital products that tackle modern challenges. Focused on driving real growth, innovating daily, and leading dedicated teams.</div>
          </AppearTitle>
        </div>
      ) : null}
      {!isMobile ? (
        <>
          ...
          >
            ...
            <AppearTitle>
              <h4 className={clsx('h4', 'bold', styles.title)}>Tech Integrators</h4>
            </AppearTitle>
            <AppearTitle>
              <div className="p-l">Building systems and digital products that tackle modern challenges. Focused on driving real growth, innovating daily, and leading dedicated teams.</div>
            </AppearTitle>
      ...
      {isMobile ? (
        <div className={styles.textMobile}>
          <AppearTitle>
            <h4 className={clsx('h4', 'bold')}>Advertising Experts</h4>
          </AppearTitle>
          <AppearTitle>
            <div className="p-l">Directed creative operations and rolled out impactful marketing campaigns. Helping brands discover their voice and reach new audiences organically.</div>
          </AppearTitle>
        </div>
      ) : null}
      {!isMobile ? (
        <>
          ...
          >
            ...
            <AppearTitle>
              <h4 className={clsx('h4', 'bold', styles.title)}>Advertising Experts</h4>
            </AppearTitle>
            <AppearTitle>
              <div className="p-l">Directed creative operations and rolled out impactful marketing campaigns. Helping brands discover their voice and reach new audiences organically.</div>
            </AppearTitle>
      ...
      {isMobile ? (
        <div className={styles.textMobile}>
          <AppearTitle>
            <h4 className={clsx('h4', 'bold')}>Planning Experts</h4>
          </AppearTitle>
          <AppearTitle>
            <div className="p-l">Guided strategy and planned events from the ground up, shaping how we operate and steering the venture to deliver memorable experiences.</div>
          </AppearTitle>
        </div>
      ) : null}
      {!isMobile ? (
        <>
          ...
          >
            ...
            <AppearTitle>
              <h4 className={clsx('h4', 'bold', styles.title)}>Planning Experts</h4>
            </AppearTitle>
            <AppearTitle>
              <div className="p-l">Guided strategy and planned events from the ground up, shaping how we operate and steering the venture to deliver memorable experiences.</div>
            </AppearTitle>
